...
contract sFLAT is ERC20Permit, Ownable {
    ...
    constructor() ERC20("Staked Flat", "sFLAT", 9) ERC20Permit() {
    ...
    /**
        @notice increases sFLAT supply to increase staking balances relative to profit_
